...
public class DatabaseController {
    ...
    public void initialize() throws IOException {
        ...
        Optional<Course> course13 = courseService.create("course13", "Descripcion1", categoryService.findByName("Crecimiento personal").get(), "Principiante", "/static/assets/images/paths/angular_430x168.png", 6, savedUser1.getId());
        Optional<Course> course14 = courseService.create("course14", "Descripcion2", categoryService.findByName("Deportes").get(), "Principiante", "/static/assets/images/paths/swift_430x168.png", 6, savedUser1.getId());
        Optional<Course> course15 = courseService.create("course15", "Descripcion3", categoryService.findByName("Disciplinas académicas").get(), "Principiante", "/static/assets/images/paths/photoshop_430x168.png", 6, savedUser1.getId());
        Optional<Course> course16 = courseService.create("course16", "Descripcion4", categoryService.findByName("Diseño").get(), "Principiante", "/static/assets/images/paths/craft_430x168.png", 6, savedUser1.getId());
        Optional<Course> course17 = courseService.create("course17", "Descripcion5", categoryService.findByName("Finanzas").get(), "Principiante", "/static/assets/images/paths/wordpress_430x168.png", 6, savedUser1.getId());
        Optional<Course> course18 = courseService.create("course18", "Descripcion6", categoryService.findByName("Fotografía y vídeo").get(), "Principiante", "/static/assets/images/paths/react_430x168.png", 6, savedUser1.getId());
        Optional<Course> course19 = courseService.create("course19", "Descripcion7", categoryService.findByName("Informática y software").get(), "Principiante", "/static/assets/images/paths/redis_430x168.png", 6, savedUser2.getId());
        Optional<Course> course20 = courseService.create("course20", "Descripcion8", categoryService.findByName("Marketing").get(), "Principiante", "/static/assets/images/paths/angular_testing_430x168.png", 6, savedUser2.getId());
        Optional<Course> course21 = courseService.create("course21", "Descripcion9", categoryService.findByName("Música").get(), "Principiante", "/static/assets/images/paths/typescript_430x168.png", 6, savedUser2.getId());
        Optional<Course> course22 = courseService.create("course22", "Descripcion10", categoryService.findByName("Profesiones").get(), "Principiante", "/static/assets/images/paths/angular_routing_430x168.png", 6, savedUser2.getId());
        Optional<Course> course23 = courseService.create("course23", "Descripcion11", categoryService.findByName("Salud").get(), "Principiante", "/static/assets/images/paths/invision_430x168.png", 6, savedUser2.getId());
        Optional<Course> course24 = courseService.create("course24", "Descripcion12", categoryService.findByName("Otros").get(), "Principiante", "/static/assets/images/paths/devops_430x168.png", 6, savedUser2.getId());
    }
}
